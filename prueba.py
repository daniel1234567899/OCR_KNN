...
def vecinos(datos_distancias,ruta):
    ...
    carac0 = carac1 = carac2 = carac3 = carac4 = carac5 = carac6 = carac7 = carac8 = carac9 = c = cA = cB = cC = cD = cE = cF = cG = cH = cI = cJ = cK = cL = cM = cN = cO = cP = cQ = cR = cS = cT = cU = cV = cW = cX = cY = cZ = c = 0
